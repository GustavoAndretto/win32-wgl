#pragma once
#define WM_KEY_PRESS			0x00
#define WM_KEY_REPEAT			0x01
#define WM_KEY_RELEASE			0x03

#define VK_KEY_PRESS			0x01 
#define VK_KEY_RELEASE			0x02
#define VK_KEY_TOGGLE			0x04
#define VK_KEY_UNTOGGLE			0x08
#define VK_KEY_REPEAT			0x10
...
#define VK_LSUPER				0x5B // Left Windows key(Natural keyboard)
#define VK_RSUPER				0x5C // Right Windows key(Natural keyboard)